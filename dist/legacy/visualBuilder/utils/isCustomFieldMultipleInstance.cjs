...
function isCustomFieldMultipleInstance(fieldSchema, fieldMetadata) {
  ...
  return (0, import_getFieldType.getFieldType)(fieldSchema) === import_types.FieldDataType.CUSTOM_FIELD && (0, import_isFieldMultiple.isFieldMultiple)(fieldSchema) && fieldMetadata.fieldPathWithIndex !== ((_a = fieldMetadata.instance) == null ? void 0 : _a.fieldPathWithIndex) && (((_b = fieldMetadata.multipleFieldMetadata) == null ? void 0 : _b.index) ?? -1) !== -1;
}
